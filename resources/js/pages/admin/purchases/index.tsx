...
export default function PurchasesIndex({ purchases, filters }: Props) {
    ...
    const handleConfirmPayment = (purchaseId: number) => {
        ...
        if (
            confirm(
                "Confirm this payment? Credits will be added to the user's account.",
            )
        ) {
            router.post(
                `/admin/purchases/${purchaseId}/confirm`,
                {
