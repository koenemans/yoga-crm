            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            View and export purchase history
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Showing {purchasesData.data.length} of{' '}
                            {purchasesData.total} purchases
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                                    ...
                                    {purchasesData.data.map(
                                        (purchase: Purchase) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-3">
                                                    <span
                                                        className={`rounded-full px-2 py-1 text-xs ${getStatusBadge(purchase.status)}`}
                                                    >
                                                        {purchase.status}
                                                    </span>
                                                </td>
                        ...
                        {purchasesData.last_page > 1 && (
                            <div className="mt-4 flex items-center justify-between">
                                <div className="text-sm text-muted-foreground">
                                    Page {purchasesData.current_page} of{' '}
                                    {purchasesData.last_page}
                                </div>
                                <div className="flex gap-2">
                                    {purchasesData.links.map(
                                        (
                                            link: {
                                                url: string | null;
                                                label: string;
