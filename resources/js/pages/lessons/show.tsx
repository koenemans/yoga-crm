...
export default function LessonShow({
    ...
    const handleCancel = () => {
        if (
            confirm(
                'Are you sure you want to cancel this lesson? All bookings will be refunded.',
            )
        ) {
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        {can_manage && (
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Participants ({lesson.bookings.length} /{' '}
                                        {lesson.capacity})
                                    </CardTitle>
                                    <CardDescription>
                                        Students booked for this class
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                                                ...
                                                                {booking.status ===
                                                                    ...
                                                                    <div className="flex gap-1">
                                                                        <Button
                                                                            ...
                                                                            onClick={() => {
                                                                                router.post(
                                                                                    `/bookings/${booking.id}/attendance`,
                                                                                    {
                                                                                        status: 'attended',
                                                                                    },
                                                                                    {
                                                ...
                                                <div className="flex gap-2 border-t pt-2">
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            if (
                                                                confirm(
                                                                    'Mark all booked students as attended?',
                                                                )
                                                            ) {
                                                                lesson.bookings
                                                                    .filter(
                        ...
                        {can_manage && lesson.waitlist.length > 0 && (
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        Waitlist ({lesson.waitlist.length})
                                    </CardTitle>
                                    <CardDescription>
                                        Students waiting for a spot
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-2">
                        ...
                        {(user.role === 'attendee' ||
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Your balance: {user_credit_balance}{' '}
                                        credits
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    {user_booked ? (
                                        ...
                                        !user_on_waitlist ? (
                                            <>
                                                <p className="text-sm text-muted-foreground">
                                                    This class is full. Join the
                                                    waitlist to be notified if a
                                                    spot opens up.
                                                </p>
                                                <Button
