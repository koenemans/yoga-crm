...
export default function TeacherDashboard({ stats, upcoming_lessons, recent_bookings }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Your teaching overview and statistics</p>
                    </div>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            {upcoming_lessons.length > 0 ? (
                                    ...
                                    <div key={lesson.id} className="flex items-start justify-between border-b pb-4 last:border-0">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                {lesson.bookings_count} / {lesson.capacity} booked ({lesson.available_spots} spots left)
                                            </p>
                                        </div>
                                ...
                                <p className="text-center text-muted-foreground">No upcoming lessons scheduled</p>
                            )}
                        </div>
                        <Button asChild variant="link" className="mt-4 w-full">
                            <Link href={lessons.index().url}>View All My Lessons</Link>
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Latest student bookings across your lessons</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                                ...
                                recent_bookings.map((booking) => (
                                    <div key={booking.id} className="flex items-center justify-between border-b pb-4 last:border-0">
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                {booking.lesson.start_datetime} • Booked on {booking.booked_at}
                                            </p>
                                        </div>
